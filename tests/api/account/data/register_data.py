INVALID_USERS = [
    {"email": "katarina.makinen@example.com", "password": "example123", "name": "Katarina Makinen"},
    {"email": "alice.smith@example.com", "password": "Alice@2023", "name": "Alice Smith"},
]
